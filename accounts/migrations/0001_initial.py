    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=233, unique=True, verbose_name='شماره موبایل')),
                ('melli_code', models.CharField(blank=True, max_length=10, verbose_name='کد ملی')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration', models.DateTimeField(auto_now_add=True, verbose_name=' تاریخ انقضا ')),
            ],
            options={
